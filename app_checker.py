...
print '```'
print row_str.format(u' ', 'App Name', 'Commit', 'Tag', 'Alembic Version').encode('utf8')
print '-' * 80

for icon_str, app_key, _db_url_with_creds in secrets.apps:
    app_name = app_key
    proc = subprocess.Popen(
    ...
    print row_str.format(icon_str, app_name, commit, tag, alembic_version).encode('utf8')
print '```'
